...
class b2c_sales_goods_item_goods extends b2c_sales_goods_item
{
    public function getItem() {
        return array(
                  ...
                  //wzy 临期商品促销，2017-4-10
                  'goods_expire_date'  => array('name'=>app::get('b2c')->_('商品有效期'),   'path'=>'expire_date',          'type'=>'goods', 'object'=>'b2c_sales_goods_item_goods', 'operator'=>array( 'equal', 'equal1'), 'input'=>'datetime', 'vtype'=>'date'),
