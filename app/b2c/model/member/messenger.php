...
class b2c_mdl_member_messenger {
    ...
    function actions(){
        $actions = array(
            ...
            'account-signup'=>array('label'=>app::get('b2c')->_('PC端手机注册验证短信'),'level'=>11,'sendType'=>'notice','b2c_messenger_msgbox'=>'false','b2c_messenger_email'=>'false','varmap'=>app::get('b2c')->_('验证码').'&nbsp;<{$vcode}>&nbsp;&nbsp;&nbsp;&nbsp;'),
            'account-signup-mobile'=>array('label'=>app::get('b2c')->_('触屏版手机注册密码发送'),'level'=>11,'sendType'=>'notice','b2c_messenger_msgbox'=>'false','b2c_messenger_email'=>'false','varmap'=>app::get('b2c')->_('验证码').'&nbsp;<{$vcode}>&nbsp;&nbsp;&nbsp;&nbsp;'),
            'account-lostPw'=>array('label'=>app::get('b2c')->_('会员找回密码'),'level'=>11,'sendType'=>'notice','b2c_messenger_msgbox'=>'false','varmap'=>app::get('b2c')->_('用户名').'&nbsp;<{$uname}>&nbsp;&nbsp;&nbsp;&nbsp;'.app::get('b2c')->_('验证码').'&nbsp;<{$vcode}>&nbsp;&nbsp;&nbsp;&nbsp;'.app::get('b2c')->_('姓名').'&nbsp;<{$name}>'),
