...
class b2c_mdl_member_attr extends dbeav_model{
   ...
   function update_order($orders){
    ...
    static function get_buildin_attr(){
         return array(
                array('attr_name'=>app::get('b2c')->_('姓名'),'attr_column'=>'name',  'attr_type'=>'text','attr_required'=>'false','attr_search'=>'false','attr_option'=>'','attr_show'=>'true','attr_edit'=>'false','attr_valtype'=>'','attr_tyname'=>app::get('b2c')->_('系统默认'),'attr_order'=>'1','attr_group'=>'defalut'),
                array('attr_name'=>app::get('b2c')->_('地区'),'attr_column'=>'area','attr_type'=>'region','attr_required'=>'false','attr_search'=>'false','attr_option'=>'','attr_show'=>'true','attr_edit'=>'false','attr_valtype'=>'','attr_tyname'=>app::get('b2c')->_('系统默认'),'attr_order'=>'4','attr_group'=>'defalut'),
                array('attr_name'=>app::get('b2c')->_('联系地址'),'attr_column'=>'addr','attr_type'=>'text','attr_required'=>'false','attr_search'=>'false','attr_option'=>'','attr_show'=>'true','attr_edit'=>'false','attr_valtype'=>'','attr_tyname'=>app::get('b2c')->_('系统默认'),'attr_order'=>'5','attr_group'=>'defalut'),
                array('attr_name'=>app::get('b2c')->_('性别'),'attr_column'=>'sex','attr_type'=>'gender','attr_required'=>'false','attr_search'=>'false','attr_option'=>'','attr_show'=>'true','attr_edit'=>'false','attr_valtype'=>'','attr_tyname'=>app::get('b2c')->_('系统默认'),'attr_order'=>'2','attr_group'=>'defalut'),
                ...
                array('attr_name'=>app::get('b2c')->_('固定电话'),'attr_column'=>'tel','attr_type'=>'text','attr_required'=>'false','attr_search'=>'false','attr_option'=>'','attr_show'=>'true','attr_edit'=>'false','attr_valtype'=>'','attr_tyname'=>app::get('b2c')->_('系统默认'),'attr_order'=>'8','attr_group'=>'defalut'),
                array('attr_name'=>app::get('b2c')->_('邮编'),'attr_column'=>'zip','attr_type'=>'text','attr_required'=>'false','attr_search'=>'false','attr_option'=>'','attr_show'=>'true','attr_edit'=>'false','attr_valtype'=>'number','attr_tyname'=>app::get('b2c')->_('系统默认'),'attr_order'=>'6','attr_group'=>'defalut'),
                array('attr_name'=>app::get('b2c')->_('出生日期'),'attr_column'=>'birthday','attr_type'=>'date','attr_required'=>'false','attr_search'=>'false','attr_option'=>'','attr_show'=>'true','attr_edit'=>'false','attr_valtype'=>'','attr_tyname'=>app::get('b2c')->_('系统默认'),'attr_order'=>'3','attr_group'=>'defalut'),
    ...
    static function get_ext_attr(){
         return  array(
            ...
            array('attr_name'=>'MSN','attr_column'=>'msn','attr_sdfpath'=>'contact/msn','attr_type'=>'text','attr_required'=>'false','attr_search'=>'false','attr_option'=>'','attr_show'=>'false','attr_edit'=>'false','attr_valtype'=>'email','attr_tyname'=>'MSN','attr_order'=>'12','attr_group'=>'contact'),
            array('attr_name'=>'Skype','attr_sdfpath'=>'contact/skype','attr_column'=>'skype','attr_type'=>'text','attr_required'=>'false','attr_search'=>'false','attr_option'=>'','attr_show'=>'false','attr_edit'=>'false','attr_valtype'=>'alphaint','attr_tyname'=>'Skype','attr_order'=>'13','attr_group'=>'contact'),
            array('attr_name'=>app::get('b2c')->_('旺旺'),'attr_column'=>'wangwang','attr_sdfpath'=>'contact/wangwang','attr_type'=>'text','attr_required'=>'false','attr_search'=>'false','attr_option'=>'','attr_show'=>'false','attr_edit'=>'false','attr_valtype'=>'alpha','attr_tyname'=>app::get('b2c')->_('旺旺'),'attr_order'=>'14','attr_group'=>'contact'),
        );
    }
