...
<?php
class trustlogin_plugin_baidu implements trustlogin_interface_trust
{
    public $name = 'baidu';
    public $app_name = 'trustlogin';
    public $ver = '2.0';
    public $view = 'trust/baidu.html';
    ...
    {
        $this->my_url = kernel::openapi_url('openapi.trustlogin_api/parse/' . $this->app->app_id . '/trustlogin_plugin_baidu', 'callback');
    ...
    {
       return app::get('trustlogin')->setConf('trustlogin_plugin_baidu', $data['data']);
    }
    ...
    public function get_logo()
    {
        ...
        $data['image'] = $this->app->res_url.'/baidu.png';
