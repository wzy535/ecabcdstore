...
<?php
class trustlogin_plugin_weibo implements trustlogin_interface_trust
{
    public $name = '新浪微博';
    public $app_name = 'trustlogin';
    public $ver = '2.0';
    public $view = 'trust/weibo.html';
    ...
    public function __construct($app)
    {
        ...
        $this->my_url = kernel::openapi_url('openapi.trustlogin_api/parse/' . $this->app->app_id . '/trustlogin_plugin_weibo', 'callback');
    ...
    {
       return app::get('trustlogin')->setConf('trustlogin_plugin_weibo', $data['data']);
    }
    ...
    public function get_logo()
    {
        ...
        $data['image'] = $this->app->res_url.'/weibo.png';
